    ...
    <v-row>
      <v-col sm="6" offset-sm="3">
        <v-stepper v-model="step">
          ...
          <v-stepper-items>
            <ContactInfo :data="info" :rules="rules" :next="next" />
            <ShippingInfo :data="info" :rules="rules" :next="next" :previous="previous"/>
            <Review :data="info" :rules="rules" :submitOrder="submitOrder" :previous="previous"/>
          </v-stepper-items>
        </v-stepper>
      </v-col>
    </v-row>
